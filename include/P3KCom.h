...
class P3KCom
{
    private:
        ...
        ssh_session sshSesh; //SSH session object
        ssh_channel sshChan; //SSH channel object
    ...
    public:
        ...
        **/
        ...
        P3KCom(); //default constructor; unused

        /**
        * Destructor. Closes SSH session if that was used.
        **/
        ~P3KCom();
